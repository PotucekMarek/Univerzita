...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="items.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'items.php' ? 'active' : 'link-dark' ?>">
                    <span class="icon">
            ...
            <li class="nav-item">
                <a href="others.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'others.php' ? 'active' : 'link-dark' ?>">
                    <span class="icon">
                        <i class="bi bi-box"></i>
                    </span>
                    Others
